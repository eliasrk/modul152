...
const Header = ({ name }: headerProps) => {
  ...
  const isGallery = router.pathname === "/";

  return (
    <>
      <div className="mb-3 flex justify-end p-5 shadow-lg ">
        <div className="flex items-center">
          <Image src="/index.svg" alt="My Icon" width={35} height={35} />
        </div>
        <div className="mr-auto flex items-center">
          <h1 className="mx-2 text-gray-900">|</h1>
          {isFeed && (
            <Link href="/">
              <h1 className="font-bold text-gray-900 hover:scale-110 hover:underline hover:underline-offset-4 active:animate-wiggle">
                Gallery
              </h1>
            </Link>
          )}
